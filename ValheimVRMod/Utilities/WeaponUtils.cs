        ...
        private static readonly Dictionary<string, WeaponColData> colliders = new Dictionary<string, WeaponColData>
        {
            {           // AXES
                ...
                "SpearWolfFang", WeaponColData.create(
                    0,  1.94f, 0,
                    0,  0, 0,
                    0.3996784f,  23.445521f, 0.4638378f
                )}, {
                "SpearFlint", WeaponColData.create(
                    0,  0, -0.262f,
                    0,  0, 0,
                    0.08946446f,  0.05617056f, 3.1811694f
                )}, {
                ...
                "SpearElderbark", WeaponColData.create(
                    0,  1.0915f, 0,
                    0,  0, 0,
                    0.07673188f,  2.3863854f, 0.02554126f
                )}, {
                "SpearBronze", WeaponColData.create(
                    0,  1.182f, 0,
                    0,  0, 0,
                    0.07756059f,  2.425059f, 0.02554126f
                )}, {
                ...
                "AtgeirBlackmetal", WeaponColData.create(
                    0,  1.261f, 0,
                    0,  0, 0,
                    0.1277498f,  2.9300777f, 0.01543969f
                )}, {
                "AtgeirBronze", WeaponColData.create(
                    0,  0, -0.329f,
                    0,  0, 0,
                    0.02239758f,  0.1504803f, 4.3769629f
                )}, {
                ...
                "SpearCarapace", WeaponColData.create(
                    0, 1.0915f, 0,
                    0, 0, 0,
                    0.07673188f,  2.6555415f, 0.02554126f
                )}, {
